...
public class ApdSampleApplicationApp {

    private static final Logger log = LoggerFactory.getLogger(ApdSampleApplicationApp.class);

    private final Environment env;

    public ApdSampleApplicationApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes apdSampleApplication.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(ApdSampleApplicationApp.class);
